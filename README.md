...
5. [Конфигурация TypeORM в app.module.ts](#конфигурация-TypeORM-в-app.module.ts)
6. [Создание сущностей (Entity)](#создание-сущностей-entity)
7. [Реализация репозитория для работы с БД](#реализация-репозитория-для-работы-с-бд)
8. [DTO. Сервис с бизнес-логикой](#DTO.-Сервис-с-бизнес-логикой)
9. [Контроллер и REST API маршруты](#контроллер-и-rest-api-маршруты)
10. [Модуль ProductsModule](#модуль-ProductsModule)
11. [Валидация и глобальные пайпы](#валидация-и-глобальные-пайпы)
12. [Тестирование GET в Postman](#тестирование-GET-в-Postman)
13. [POST запрос](#POST-запрос)
...
Пример:По умолчанию PostgreSQL использует порт 5432:5432. Если он занят, измените конфигурацию на 5439:5432. В этом случае:
...
**TypeORM** — это библиотека для работы с базами данных в TypeScript/Node.js, которая позволяет взаимодействовать с SQL-базами (как PostgreSQL) через объекты и классы вместо написания сырых SQL-запросов.
...
**Его задача** — сказать NestJS: «Вот все части модуля продуктов, собери их воедино». Без этого модуля контроллер, сервис и репозиторий не будут работать вместе.
